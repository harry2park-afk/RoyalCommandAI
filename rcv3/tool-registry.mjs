...
const entries = /** @type {const} */ ([
  ...
  {id:'room-list',label:'My Rooms',description:'Search your created rooms and move directly between them. Return to the named basic room when its verified account mapping is available.',requires:'Authenticated owned room list. Never infer a basic room or bypass room permissions; disable navigation while edits are unsaved.',source:'src/components/rcv3-toolbox/RoomNavigation.tsx'},
  ...
  {id:'edit-buttons',label:'Edit Buttons',description:'Move, resize, recolour, rename or remove installed buttons. Same Style mode continuously copies visual size and appearance to each button selected while preserving its label, position and function.',requires:'Save or cancel your current edits first.',source:'src/app/rcv3/Room.tsx'},
