...
const entries = /** @type {const} */ ([
  ...
  {id:'create-room',label:'Create Room',description:'Open the existing room creation form, design and connection options.',requires:'Existing price, account and payment conditions apply.',source:'src/app/rcv3/create/CreateRoomWizard.tsx'},
