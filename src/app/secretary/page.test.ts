...
vi.mock("@/lib/runtime/serverDomainContext", () => ({ getServerDomainRuntimeContext: async () => ({ locale: "en-AU", country: null }) }));
...
vi.mock("../rooms/[id]/CustomerAISecretary", () => ({ default: ({ roomId }: { roomId: string }) => createElement("div", null, `secretary:${roomId}:${useDomainRuntime().locale}`) }));
