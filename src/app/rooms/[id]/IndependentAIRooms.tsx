...
function CountryFlag({ countryCode }: { countryCode: string }) {
  const flag = /^[A-Z]{2}$/.test(countryCode)
    ...
    : "";
  return flag ? <span aria-hidden="true" className="w-6 shrink-0 text-center text-lg leading-none">{flag}</span> : null;
}
