    ...
    <main className={`${styles.root} min-h-[100dvh] bg-[#07101d] text-[#f4f0e7]`}>
      <header className="sticky top-0 z-50 border-b border-[#d7b64d]/25 bg-[#07101d]/95 backdrop-blur">
        <div data-rc-top-controls className="relative flex h-14 items-center gap-2 px-3 sm:px-4">
          ...
          {roomId === "rca" && <a href="/rcv3" className="flex shrink-0 items-center rounded-lg border border-emerald-300/60 bg-emerald-950/40 px-3 py-2 text-sm font-semibold text-emerald-200">RC V3</a>}
          <a href="/secretary" className="flex shrink-0 items-center rounded-lg border border-[#d7b64d]/50 bg-[#0b1524] px-3 py-2 text-sm text-[#f0d36a]">Katie 비서방</a>
