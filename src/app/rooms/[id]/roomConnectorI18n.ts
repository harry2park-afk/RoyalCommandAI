export type ConnectorTextKey =
  ...
  | "trialPolicyTitle" | "trialPolicyBody" | "trialConsent" | "chargeNotice" | "cancelPolicy" | "freeTrial" | "thenPay";
...
const EN: Dict = {
  ...
  trialPolicyTitle: "Free trial & renewal", trialPolicyBody: "When a supplier offers a free trial, Royal Command shows the same verified trial period. A trial converts to paid service only after the customer explicitly agrees to automatic renewal.",
  trialConsent: "After the free trial, the displayed monthly price may be charged automatically unless cancelled before the renewal date.",
  chargeNotice: "A reminder must be sent before the first paid charge and before renewal when required.",
  cancelPolicy: "Cancel anytime. If a paid month has already started, access continues until the end of the paid period and the next renewal is stopped.",
  freeTrial: "FREE trial", thenPay: "then",
};
...
const KO: Dict = {
  ...
  trialPolicyTitle: "무료체험 및 자동갱신", trialPolicyBody: "공급업체가 무료체험을 제공하는 경우 Royal Command도 확인된 동일 기간을 표시합니다. 고객이 자동 유료전환에 명확히 동의한 경우에만 체험 종료 후 유료로 전환됩니다.",
  trialConsent: "무료체험 종료 후 취소하지 않으면 표시된 월 요금이 자동 청구될 수 있습니다.",
  chargeNotice: "첫 유료 청구 전과 필요한 갱신 전에 고객에게 알림을 보냅니다.",
  cancelPolicy: "언제든 취소할 수 있습니다. 이미 결제된 월은 결제기간 마지막 날까지 사용할 수 있고 다음 갱신부터 청구가 중지됩니다.",
  freeTrial: "무료체험", thenPay: "이후",
};
...
const ZH_CN: Dict = {
  ...
  agreementBody: "我同意将所选项目连接到此房间，并接受显示的价格、免费试用、自动续费及适用的 Royal Command 服务条款。",
  agreeAndSend: "同意并发送", paymentTitle: "付款", paymentUnavailable: "付款功能尚未启用。在服务器确认付款之前，付费连接不会激活。",
  ok: "确定", loadError: "无法加载连接", connectError: "连接请求失败", disconnectError: "断开连接失败", nothingSelected: "请先选择至少一项。",
  trialPolicyTitle: "免费试用与自动续费", trialPolicyBody: "供应商提供免费试用时，Royal Command 仅显示已核实的相同试用期。只有客户明确同意自动续费后，试用结束才可转为付费服务。",
  trialConsent: "免费试用结束后，如未取消，可按显示的月费自动扣款。", chargeNotice: "首次收费前及需要时的续费前会发送提醒。",
  cancelPolicy: "可随时取消。若已进入付费月，可使用至该付费周期结束，下一次续费将停止。", freeTrial: "免费试用", thenPay: "之后",
};
...
const ZH_TW: Dict = {
  ...
  agreementBody: "我同意將所選項目連接到此房間，並接受顯示的價格、免費試用、自動續費及適用的 Royal Command 服務條款。",
  agreeAndSend: "同意並傳送", paymentTitle: "付款", paymentUnavailable: "付款功能尚未啟用。在伺服器確認付款之前，付費連接不會啟用。",
  ok: "確定", loadError: "無法載入連接", connectError: "連接請求失敗", disconnectError: "中斷連接失敗", nothingSelected: "請先選擇至少一項。",
  trialPolicyTitle: "免費試用與自動續費", trialPolicyBody: "供應商提供免費試用時，Royal Command 僅顯示已核實的相同試用期。只有客戶明確同意自動續費後，試用結束才可轉為付費服務。",
  trialConsent: "免費試用結束後，如未取消，可按顯示的月費自動扣款。", chargeNotice: "首次收費前及需要時的續費前會發送提醒。",
  cancelPolicy: "可隨時取消。若已進入付費月，可使用至該付費週期結束，下一次續費將停止。", freeTrial: "免費試用", thenPay: "之後",
};
...
const AR: Dict = {
  ...
  ok: "حسنًا", loadError: "تعذر تحميل الاتصالات", connectError: "فشل طلب الاتصال", disconnectError: "فشل قطع الاتصال", nothingSelected: "اختر عنصرًا واحدًا على الأقل أولاً.",
  trialPolicyTitle: "التجربة المجانية والتجديد", trialPolicyBody: "عندما يقدم المورد تجربة مجانية، تعرض Royal Command فقط مدة التجربة المؤكدة نفسها. يتحول الاشتراك إلى مدفوع فقط بعد موافقة العميل الصريحة على التجديد التلقائي.",
  trialConsent: "بعد انتهاء التجربة المجانية قد يتم تحصيل السعر الشهري المعروض تلقائيًا ما لم يتم الإلغاء قبل موعد التجديد.", chargeNotice: "يتم إرسال تذكير قبل أول دفعة وقبل التجديد عند الحاجة.",
  cancelPolicy: "يمكن الإلغاء في أي وقت. إذا بدأ شهر مدفوع بالفعل يستمر الوصول حتى نهاية الفترة المدفوعة ويتوقف التجديد التالي.", freeTrial: "تجربة مجانية", thenPay: "ثم",
};
