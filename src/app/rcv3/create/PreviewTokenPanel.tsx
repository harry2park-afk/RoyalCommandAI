...
export default function PreviewTokenPanel({draftId,revision,disabled,language}:{draftId:string;revision:number;disabled:boolean;language:string}) {
 ...
 return <section aria-label={t("payment")}>
  ...
  {showBank&&<div style={{border:"1px solid #466078",borderRadius:12,padding:16,marginTop:12,marginBottom:16}}>
   ...
   {bank&&<p><a href={{anz:"https://www.anz.com.au/personal/internet-banking/",cba:"https://www.commbank.com.au/digital-banking/netbank.html",westpac:"https://www.westpac.com.au/personal-banking/online-banking/"}[bank as "anz"|"cba"|"westpac"]} rel="noreferrer">{language.startsWith("ko")?`${bank==="westpac"?"Westpac":bank.toUpperCase()} 공식 인터넷뱅킹으로 이동`:`Continue to ${bank.toUpperCase()} official online banking`}</a></p>}
