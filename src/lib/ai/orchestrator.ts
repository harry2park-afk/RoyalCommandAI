  ...
  return {
    ...
    comparison: {
      ...
      notes: [
        ...
        "Each provider is required to preserve independent judgment and use the strongest capabilities actually available through its own connected model without racing or conforming to sibling AIs.",
