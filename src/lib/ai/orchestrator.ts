...
function providerSystem(id: AIProviderId, languageHint: string, systemExtra?: string) {
  ...
  return [
    ...
    "SPEED STANDARD: Respond as quickly and efficiently as possible without sacrificing the quality standard above. The user should not need to ask you to hurry. Avoid unnecessary preambles, repeated restatement, meta-commentary, artificial waiting, or needless internal work that delays a useful answer. Give the best complete answer promptly.",
