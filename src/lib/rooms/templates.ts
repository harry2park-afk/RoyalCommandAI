...
export const ROOM_TEMPLATES: RoomTemplate[] = [
  ...
  {
    id: "finance",
    name: "Finance / Money Services",
    shortDescription: "Loans, finance broking, payments, remittance, FX and future banking-ready Room",
    suggestedAgents: [
      "Finance Reception",
      "Loan Intake",
      "Document Checker",
    ...
    fields: [
      {
        id: "financeService",
        label: "Which finance services do you want in this Room?",
        options: [
          "Loans / finance broking",
          "Mortgage assistance",
          "Business finance",
          "Payments / bill support",
          "Foreign exchange",
          "International remittance",
          "Investment / financial services",
          "Future banking-ready setup",
          "AI recommend",
        ],
      },
      {
        id: "customerType",
        label: "Main customer type",
        options: ["Individuals", "Small business", "Companies", "Property investors", "Mixed", "AI recommend"],
      },
      {
        id: "loanPurpose",
        label: "Main lending / finance purpose",
        placeholder: "e.g. home loan, refinance, vehicle, equipment, working capital, commercial property",
      },
      {
        id: "moneyMovement",
        label: "Money movement required",
        options: [
          "No money movement — advice/intake only",
          "Partner bank/payment provider",
          "International remittance",
          "Foreign exchange",
          "Customer wallet/account in future",
          "AI recommend",
        ],
      },
      {
        ...
        options: [
          "Partner / representative model",
          "Own Australian Credit Licence",
          "AUSTRAC remittance registration",
          "AFS licence capability",
          "Future ADI / bank stage",
          "AI recommend",
        ],
      },
      {
        id: "verification",
        label: "Customer verification level",
        options: ["Basic identity", "KYC", "Enhanced KYC / AML", "Business verification", "AI recommend"],
      },
      {
        id: "channels",
        label: "Customer service channels",
        options: ["Chat", "Voice", "Video", "Phone", "Email", "Mixed", "AI recommend"],
      },
      {
        id: "futureFeatures",
        label: "Future banking features to prepare for",
        placeholder: "e.g. customer balance, multi-currency, transfers, cards, statements, savings, treasury, secure payout",
      },
    ],
  },
  {
