export type CreateRoomLocale = "en" | "fr" | "ko" | "ja" | "zh" | "vi" | "id" | "th" | "hi";
...
const EN = {
  ...
  step1Help: "Example: Create an accountant office for three staff with client documents, phone calls and appointments.",
  ...
  websiteBenefit: "Starter Website Benefit eligibility depends on the selected plan and country. Final availability is confirmed during review.",
  edit: "Edit",
  ...
  pendingIntegration: "Electronic signature, payment, cancellation/renewal policy, local tax treatment and final usage prices will be connected before public launch.",
...
const COPY: Record<CreateRoomLocale, Copy> = {
  ...
  fr: {
    ...EN,
    title: "Créer votre Room",
    subtitle: "Décrivez votre besoin en une ou deux phrases. Royal Command vous proposera une configuration de départ simple.",
    steps: ["Décrire", "Recommander", "Personnaliser", "Vérifier", "Accord"],
    step1Title: "Quel type de Room souhaitez-vous créer ?",
    step1Help: "Exemple : créez un cabinet comptable pour trois employés avec des documents clients, des appels téléphoniques et des rendez-vous.",
    placeholder: "Décrivez votre Room en une ou deux phrases...",
    teamSize: "Taille de l’équipe",
    language: "Langue",
    country: "Pays",
    aiRecommend: "Recommander ma Room avec l’IA",
    direct: "Choisir moi-même",
    step2Title: "Recommandation de l’IA",
    recommendedRoom: "Room recommandée",
    choosePackage: "Choisissez une formule de départ. Tout pourra être modifié à l’étape suivante.",
    good: "Good · Essentiel",
    better: "Better · Recommandé",
    best: "Best · Bureau complet",
    goodDesc: "Fonctions essentielles uniquement.",
    betterDesc: "Configuration équilibrée selon votre description.",
    bestDesc: "Ensemble plus large d’outils de bureau, de communication et de service client.",
    step3Title: "Personnalisez uniquement ce dont vous avez besoin",
    step3Help: "Une coche verte indique un service sélectionné. Appuyez à nouveau pour le retirer et mettre le total à jour immédiatement.",
    back: "Retour",
    review: "Vérifier la sélection",
    step4Title: "Vérification finale",
    step4Help: "Seuls les services sélectionnés apparaissent ci-dessous. Appuyez sur un élément coché en vert pour le retirer.",
    noAddons: "Aucun service complémentaire sélectionné. Basic RC Room uniquement.",
    roomType: "Type de Room",
    team: "Équipe",
    trial: "Basic RC Room",
    trialText: "jours GRATUITS, puis",
    training: "Avantage de formation IA inclus",
    websiteBenefit: "L’admissibilité à l’avantage Starter Website dépend de la formule et du pays. La disponibilité finale est confirmée lors de la vérification.",
    edit: "Modifier",
    agreementPayment: "Accord et paiement",
    step5Title: "Accord et paiement",
    step5Help: "La signature électronique et les connexions de paiement seront intégrées et testées avant le lancement public.",
    agreement: "J’ai vérifié les services sélectionnés, les conditions d’essai et l’estimation récurrente.",
    pendingIntegration: "La signature électronique, le paiement, les règles d’annulation et de renouvellement, le traitement fiscal local et les tarifs d’utilisation définitifs seront connectés avant le lancement public.",
    readyPreview: "Prêt pour l’intégration Preview",
    livePrice: "Résumé des prix",
    today: "Aujourd’hui",
    afterTrial: "Après l’essai / mois",
    oneTime: "Travail de site web ponctuel",
    promotion: "Promotion",
    ...
    version: "Universal Create Room",
    basicBenefit: "Formation IA de 30 jours · 5 tentatives d’examen par cycle · réussite à 70 % · cycles d’étude supplémentaires de 2 semaines jusqu’à la réussite · certificat électronique inclus.",
  },
  ko: { ...EN,
    title: "나의 Room 만들기", subtitle: "원하는 Room을 한두 문장으로 말씀해 주세요. Royal Command가 가장 간단한 시작 구성을 추천합니다.",
    steps: ["설명", "AI 추천", "서비스 조정", "최종 확인", "동의·결제"], step1Title: "어떤 Room을 만들어 드릴까요?", step1Help: "예: 직원 3명이 쓰는 회계사 사무실. 고객 서류, 전화, 예약, 세금 알림이 필요합니다.", placeholder: "원하는 Room을 한두 문장으로 적어 주세요...", teamSize: "팀 인원", language: "언어", country: "국가", aiRecommend: "AI가 Room 추천", direct: "직접 고르기", step2Title: "AI 추천", recommendedRoom: "추천 Room", choosePackage: "시작 패키지를 고르세요. 다음 단계에서 모두 바꿀 수 있습니다.", good: "Good · 기본", better: "Better · 추천", best: "Best · Full Office", goodDesc: "핵심 기능만 사용합니다.", betterDesc: "설명에 맞춘 균형 잡힌 추천 구성입니다.", bestDesc: "업무·통신·고객 기능을 넓게 포함합니다.", step3Title: "필요한 서비스만 조정하세요", step3Help: "선택한 항목은 선명한 초록색 ✓로 표시됩니다. 다시 누르면 즉시 해제되고 금액도 자동 공제됩니다.", back: "뒤로", review: "선택 내용 확인", step4Title: "최종 확인", step4Help: "선택한 서비스만 표시됩니다. 초록색 ✓ 항목을 다시 누르면 바로 제거됩니다.", noAddons: "추가 서비스를 선택하지 않았습니다. Basic RC Room만 사용합니다.", roomType: "Room 종류", team: "팀", trial: "Basic RC Room", trialText: "일 무료, 이후", training: "AI 교육 혜택 포함", websiteBenefit: "Starter Website 혜택 대상 여부는 선택한 플랜과 국가에 따라 달라집니다. 최종 제공 여부는 검토 단계에서 확인됩니다.", edit: "수정", agreementPayment: "동의 및 결제", step5Title: "동의 및 결제", step5Help: "전자서명과 결제 시스템은 공개 전에 실제 시스템으로 연결하고 테스트합니다.", agreement: "선택 서비스, 무료 체험 조건 및 월 예상금액을 확인했습니다.", pendingIntegration: "전자서명·결제·해지/갱신 정책·현지 세금 처리·사용량 요금은 공개 전에 최종 연결합니다.", readyPreview: "Preview 연결 준비", livePrice: "실시간 가격", today: "오늘 결제", afterTrial: "무료기간 후 월", oneTime: "웹 제작 일회성", promotion: "프로모션 할인", save: "절약 금액", total: "최종 월 금액", priceToConfirm: "가격 추후 확정", included: "포함", from: "부터", selected: "선택됨", version: "Universal Create Room", basicBenefit: "30일 AI 교육 · 시험 5회씩 · 70점 합격 · 불합격 시 2주 무료 추가학습 반복 · 전자 수료증 무료." },
  ja: { ...EN, title: "Roomを作成", subtitle: "必要なRoomを1〜2文で説明してください。Royal Commandが最適な開始構成を提案します。", steps: ["説明", "AI提案", "調整", "確認", "同意・決済"], step1Title: "どのようなRoomを作りますか？", step1Help: "例：スタッフ3名の会計事務所。顧客書類、電話、予約、税務通知が必要です。", placeholder: "必要なRoomを1〜2文で入力してください...", teamSize: "人数", language: "言語", country: "国", aiRecommend: "AIにRoomを提案してもらう", direct: "自分で選ぶ", step2Title: "AI提案", recommendedRoom: "おすすめRoom", choosePackage: "開始パッケージを選択してください。次のステップで変更できます。", goodDesc: "基本機能のみ。", betterDesc: "ご説明に基づくバランスの取れた推奨構成です。", bestDesc: "業務、コミュニケーション、顧客対応の機能を幅広く含みます。", step3Title: "必要なサービスだけ調整", step3Help: "選択項目は緑の✓で表示されます。もう一度押すと解除され、料金も更新されます。", back: "戻る", review: "選択内容を確認", step4Title: "最終確認", step4Help: "選択したサービスだけ表示されます。", noAddons: "追加サービスは選択されていません。", roomType: "Roomの種類", team: "チーム", trialText: "日間無料、その後", training: "AIトレーニング特典を含む", websiteBenefit: "Starter Website特典の対象可否は、選択したプランと国によって異なります。最終的な提供可否は確認時に確定します。", edit: "編集", agreementPayment: "同意・決済", step5Title: "同意・決済", step5Help: "電子署名と決済連携は、公開前に統合しテストします。", agreement: "選択したサービス、無料トライアル条件、継続料金の見積りを確認しました。", pendingIntegration: "電子署名、決済、解約・更新ポリシー、現地税務処理、最終的な従量料金は公開前に接続します。", readyPreview: "Preview連携の準備完了", livePrice: "リアルタイム料金", today: "本日", afterTrial: "無料期間後/月", oneTime: "Web制作一回料金", promotion: "プロモーション", save: "節約額", total: "月額合計", priceToConfirm: "価格は要確認", included: "含まれる", from: "から", selected: "選択済み", basicBenefit: "30日間のAIトレーニング · 1サイクルにつき試験5回 · 70%で合格 · 合格するまで2週間の追加学習サイクル · 電子修了証を含む。" },
  zh: { ...EN, title: "创建您的 Room", subtitle: "请用一两句话告诉我们您需要什么。Royal Command 会推荐合适的初始配置。", steps: ["说明", "AI推荐", "调整服务", "最终确认", "同意与付款"], step1Title: "您想创建什么样的 Room？", step1Help: "例如：为3名员工创建会计办公室，需要客户文件、电话、预约和税务提醒。", placeholder: "请用一两句话描述您的 Room...", teamSize: "团队人数", language: "语言", country: "国家/地区", aiRecommend: "让AI推荐Room", direct: "自行选择", step2Title: "AI推荐", recommendedRoom: "推荐Room", choosePackage: "请选择起始套餐，下一步仍可修改。", step3Title: "只调整您需要的服务", step3Help: "已选择项目显示绿色✓。再次点击即可取消并立即更新费用。", back: "返回", review: "查看选择", step4Title: "最终确认", step4Help: "这里只显示已选择的服务。", noAddons: "未选择附加服务。", edit: "修改", agreementPayment: "同意与付款", step5Title: "同意与付款", livePrice: "实时价格", today: "今天", afterTrial: "试用后/月", oneTime: "网站制作一次性费用", promotion: "促销优惠", save: "您节省", total: "每月总计" },
