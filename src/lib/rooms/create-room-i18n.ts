...
const COPY: Record<CreateRoomLocale, Copy> = {
  ...
  ja: {
    ...EN,
    title: "Roomを作成",
    subtitle: "必要なRoomを1〜2文で説明してください。Royal Commandが最適な開始構成を提案します。",
    steps: ["説明", "AI提案", "調整", "確認", "同意・決済"],
    step1Title: "どのようなRoomを作りますか？",
    step1Help: "例：スタッフ3名の会計事務所。顧客書類、電話、予約、GST通知が必要です。",
    placeholder: "必要なRoomを1〜2文で入力してください...",
    teamSize: "人数",
    language: "言語",
    country: "国",
    aiRecommend: "AIにRoomを提案してもらう",
    direct: "自分で選ぶ",
    step2Title: "AI提案",
    recommendedRoom: "おすすめRoom",
    choosePackage: "開始パッケージを選択してください。次のステップで変更できます。",
    good: "Good · 基本",
    better: "Better · おすすめ",
    best: "Best · フルオフィス",
    goodDesc: "基本ツールのみ。",
    betterDesc: "入力内容に基づいたバランスのよい構成です。",
    bestDesc: "業務、コミュニケーション、顧客対応ツールを幅広く含みます。",
    step3Title: "必要なサービスだけ調整",
    step3Help: "選択項目は緑の✓で表示されます。もう一度押すと解除され、料金も更新されます。",
    back: "戻る",
    review: "選択内容を確認",
    step4Title: "最終確認",
    step4Help: "選択したサービスだけ表示されます。",
    noAddons: "追加サービスは選択されていません。",
    roomType: "Roomの種類",
    team: "チーム",
    trial: "Basic RC Room",
    trialText: "日間無料、その後",
    training: "AIトレーニング特典付き",
    websiteBenefit: "Starter Website特典の対象可否はプランと国により異なります。最終的な提供可否は確認時に確定します。",
    edit: "編集",
    agreementPayment: "同意・決済",
    step5Title: "同意・決済",
    step5Help: "電子署名と決済連携は、一般公開前に統合してテストします。",
    agreement: "選択したサービス、トライアル条件、継続料金の見積もりを確認しました。",
    pendingIntegration: "電子署名、決済、解約・更新ポリシー、現地の税務処理、最終的な従量料金は一般公開前に接続・確定します。",
    ...
    save: "節約額",
    total: "月額合計",
    priceToConfirm: "価格確認中",
    included: "含む",
    from: "～",
    selected: "選択済み",
    version: "Universal Create Room",
    basicBenefit: "30日間のAIトレーニング · 1サイクル5回の試験 · 70％以上で合格 · 不合格の場合は合格まで2週間の追加学習サイクル · 電子修了証付き。",
  },
