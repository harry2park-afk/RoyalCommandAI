...
const messages = {
 ...
 drafts:["Saved rooms in progress","작성 중인 방"], new:["Start a new room","새 방 작성"], cancel:["Cancel this draft","현재 작성 취소"], retry:["Retry","다시 시도"], fork:["Save as a new room","새 방으로 저장"],
