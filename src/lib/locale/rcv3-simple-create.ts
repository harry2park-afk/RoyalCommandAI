...
const messages = {
 ...
 secretary:["AI secretary","AI 비서"], secretaryDescription:["Helps review and summarise email, draft replies, take calls and pass on messages, and prepare appointment calls and schedules. Email and phone services require connection; outgoing calls and bookings require your approval.","이메일 검토·요약과 답장 초안, 전화 받기와 메시지 전달, 예약 전화와 일정 준비를 돕습니다. 메일·전화는 연결이 필요하며, 전화 걸기와 예약 확정은 본인 승인 후 진행됩니다."], specialist:["Specialist AI","전문 AI"], email:["Secretary email","비서 이메일"], phone:["Contact phone (optional)","연락처 (선택)"],
