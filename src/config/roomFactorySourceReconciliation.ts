 ...
 * candidate source and every candidate template has a Domain Profile.
 *
...
export function evaluateRoomFactorySourceReconciliation(
  ...
  return {
    consistent: hostedTemplatesMissingFromSource.length === 0 && sourceTemplatesMissingDomainProfiles.length === 0,
